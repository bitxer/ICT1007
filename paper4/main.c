...
int main() {
    ...
    int process[max], burst_time[max], remain_time[max], arrival_time[max], waiting_Time[max], turnaround_time[max];
    int first_burst_time = 0, highest_burst_time = 0, inital_highest_burst_time = 0, totalExecutionTime = 0, count = 0, number_of_process_with_0_arrival_time = 0;
    int *remain_process_ptr, *count_ptr, *number_of_process_with_0_arrival_time_ptr;
    ...
    */
    ...
    first_burst_time = create_processes(number_of_process, arrival_time, burst_time, remain_time, process, number_of_process_with_0_arrival_time_ptr, first_burst_time, count_ptr);
    ...
    */
    ...
    totalExecutionTime = first_process_dynamic_round_robin_execution(number_of_process, count, number_of_process_with_0_arrival_time, arrival_time, burst_time, timeQuantum, remain_time, totalExecutionTime, waiting_Time, turnaround_time, remain_process_ptr);
    ...
    sort_by_arrival(number_of_process, arrival_time, process, burst_time, remain_time, waiting_Time, turnaround_time);
    ...
    */
    ...
    output_result(process, arrival_time, burst_time, waiting_Time, turnaround_time, number_of_process);
